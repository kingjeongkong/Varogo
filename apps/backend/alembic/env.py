...
def get_url() -> str:
    url = re.sub(r'^postgres(ql)?://', 'postgresql+asyncpg://', settings.DATABASE_URL, count=1)
    # Strip Prisma-specific query params (e.g. ?schema=public) that asyncpg doesn't support
